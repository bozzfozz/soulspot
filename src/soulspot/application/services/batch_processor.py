...
# NOTE: SpotifyBatchProcessor was removed (dead code - never implemented/used)
# If needed in the future, implement actual Spotify API batch calls in the
# Spotify plugin: plugins/spotify/_batch_processor.py
# Generic BatchProcessor above is still available for use with any API.
