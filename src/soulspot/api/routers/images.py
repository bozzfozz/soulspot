"""Image serving endpoint for local library images.

Hey future me - this serves locally stored album/artist images!
...
# Hey future me - this serves local image files from the IMAGE_PATH directory!
...
async def serve_image(
    ...
    Args:
        file_path: Relative path to image file (from image_path setting)
    ...
    try:
        ...
        logger.error(f"Error resolving image path: {e}", exc_info=True)
