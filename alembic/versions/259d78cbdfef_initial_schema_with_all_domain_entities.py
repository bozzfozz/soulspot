...
def upgrade() -> None:
    ...
    op.create_index(
        op.f("ix_artists_musicbrainz_id"), "artists", ["musicbrainz_id"], unique=True
    )
    op.create_index(op.f("ix_artists_name"), "artists", ["name"], unique=False)
    op.create_index(
        op.f("ix_artists_spotify_uri"), "artists", ["spotify_uri"], unique=True
    )
    op.create_table(
        "playlists",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_playlists_spotify_uri"), "playlists", ["spotify_uri"], unique=True
    )
    op.create_table(
        "albums",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_albums_musicbrainz_id"), "albums", ["musicbrainz_id"], unique=True
    )
    op.create_index(
        op.f("ix_albums_release_year"), "albums", ["release_year"], unique=False
    )
    op.create_index(
        op.f("ix_albums_spotify_uri"), "albums", ["spotify_uri"], unique=True
    )
    op.create_index(op.f("ix_albums_title"), "albums", ["title"], unique=False)
    op.create_index(
        "ix_albums_title_artist", "albums", ["title", "artist_id"], unique=False
    )
    op.create_table(
        "tracks",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        op.f("ix_tracks_musicbrainz_id"), "tracks", ["musicbrainz_id"], unique=True
    )
    op.create_index(
        op.f("ix_tracks_spotify_uri"), "tracks", ["spotify_uri"], unique=True
    )
    op.create_index(op.f("ix_tracks_title"), "tracks", ["title"], unique=False)
    op.create_index(
        "ix_tracks_title_artist", "tracks", ["title", "artist_id"], unique=False
    )
    op.create_table(
        "downloads",
        sa.Column("id", sa.String(length=36), nullable=False),
    ...
    op.create_index(
        "ix_downloads_status_created",
        "downloads",
        ["status", "created_at"],
        unique=False,
    )
    op.create_index(
        op.f("ix_downloads_track_id"), "downloads", ["track_id"], unique=True
    )
    op.create_table(
        "playlist_tracks",
